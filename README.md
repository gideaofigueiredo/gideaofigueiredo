## Olá, sou Gideão Figueiredo 👋
 
**Engenheiro de Produção · Analista Financeiro · Entusiasta de Dados & Automação**

---

### Sobre mim
 
Graduado em **Engenharia de Produção** pela UFERSA, atuo como **Assistente Financeiro** na área de gestão de contas a receber, relatórios e indicadores de desempenho. Apaixonado por transformar dados em decisões, criando automações e ferramentas que otimizam processos no dia a dia.
 
- 🔭 Atualmente trabalhando com análise financeira, automação de processos e BI
- 🌱 Aprimorando habilidades em Python, análise de dados e desenvolvimento de sistemas
- 💡 Interesse em Lean Six Sigma, melhoria contínua e eficiência operacional
- 🤖 Explorando IA aplicada a automações e chatbots
...
![Excel](https://img.shields.io/badge/Excel_+_VBA-217346?style=flat&logo=microsoftexcel&logoColor=white)
 
**Sistemas & Gestão**
 
![TOTVS](https://img.shields.io/badge/TOTVS_Protheus-E3001B?style=flat&logoColor=white)
![ERP](https://img.shields.io/badge/Sistemas_ERP-555555?style=flat&logoColor=white)
